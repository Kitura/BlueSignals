...
public class Signals {
    ...
    ///
    public class func trap(signal: Signal, mask: sigset_t = 0, flags: CInt = 0, action: @escaping SigActionHandler) {
    ...
    ///
    public class func trap(signals: [Signal], mask: sigset_t = 0, flags: CInt = 0, action: @escaping SigActionHandler) {
